...
let createExpense = async (req, res, next) => {
...
let getExpensesByTrip = async (req, res, next) => {
  let filters={
...
let getExpenseById = async (req, res, next) => {
